  ...
  if (type === 'context') {
    ...
    try {
      ...
      if ((err as NodeJS.ErrnoException).code === 'EEXIST') {
        console.log(`ℹ️  domain/contexts/${name}/CONTEXT.md already exists — left unchanged`);
      } else {
        throw err;
      }
    }
    ...
    try {
      ...
      if ((err as NodeJS.ErrnoException).code === 'EEXIST') {
        console.log(`ℹ️  domain/workflows/${name}/SKILL.md already exists — left unchanged`);
      } else {
        throw err;
      }
    }
